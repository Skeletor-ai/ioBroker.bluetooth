...
class BluezManager extends EventEmitter {
    ...
    constructor(opts) {
        ...
        /** @type {import('@deltachat/dbus-next').MessageBus|null} */
        this._bus = null;
        /** @type {import('@deltachat/dbus-next').ProxyObject|null} */
         ...
         * @type {Map<string, import('@deltachat/dbus-next').ProxyObject>}
         */
     ...
     * @param {string} path
     * @returns {Promise<import('@deltachat/dbus-next').ProxyObject>}
     * @private
     */
    ...
    _parseManufacturerData(mfData) {
        ...
        const byteArray = Array.isArray(payloadBytes) ? payloadBytes : [];

        const buf = Buffer.alloc(2 + byteArray.length);
